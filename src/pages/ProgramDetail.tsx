    ...
    <>
      <header className="relative w-full min-h-[70vh] flex items-center justify-center overflow-hidden -mt-20">
        <div className="absolute inset-0 w-full h-full">
          <PlaceholderImage
            imgSrc={IMAGES.programDetail}
            fallbackLabel="programDetail"
        ...
        <div className="relative z-10 max-w-container-max mx-auto px-4 md:px-12 w-full text-center md:text-left pt-20">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="max-w-3xl bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-8 md:p-12 shadow-[0_0_40px_rgba(11,31,58,0.2)]">
            ...
            <p className="text-lg text-inverse-on-surface mb-8 opacity-90 leading-relaxed">Ensuring every mother and child has access to dignified, professional medical care in critical moments. We bridge the gap between remote communities and essential health services.</p>
      ...
      <section className="py-20 md:py-32 px-4 md:px-12 max-w-container-max mx-auto bg-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-primary-container p-8 rounded-xl h-full flex flex-col justify-center text-on-primary shadow-lg relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <ul className="space-y-4 font-medium">
                  <li className="flex items-center gap-3 transform hover:translate-x-2 transition-transform"><span className="w-2 h-2 rounded-full bg-secondary-container shadow-[0_0_10px_rgba(253,118,26,0.8)]"></span>24/7 Mobile Emergency Transport</li>
                  <li className="flex items-center gap-3 transform hover:translate-x-2 transition-transform"><span className="w-2 h-2 rounded-full bg-secondary-container shadow-[0_0_10px_rgba(253,118,26,0.8)]"></span>Fully Stocked Community Clinics</li>
                  <li className="flex items-center gap-3 transform hover:translate-x-2 transition-transform"><span className="w-2 h-2 rounded-full bg-secondary-container shadow-[0_0_10px_rgba(253,118,26,0.8)]"></span>Certified Midwife Training Programs</li>
                </ul>
              </div>
            </div>
          </motion.div>
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.4 }} className="md:col-span-2 rounded-xl overflow-hidden relative h-[300px] border border-outline-variant/30 group">
            <PlaceholderImage
              imgSrc={IMAGES.programDetailInner}
              fallbackLabel="programDetailInner"
              alt="Mobile Clinic"
